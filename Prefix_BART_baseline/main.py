...
from define_model import PrefixBartModel
...
def main(dataset_args, trainer_args, model_args):
    ...
    model = PrefixBartModel(**model_args)
    ...
    with open(f'predictions/{dataset_args["domain"]}_100_predictions.txt', 'w', encoding='UTF-8') as f:
...
if __name__ == '__main__':
    ...
    model_args = {
        ...
        'prompt_file': 'prefix_checkpoints/init_prefix_weights.pt',
        'off_the_shelf_prefix_path': 'prefix_checkpoints/prefix_weights.pt',
        'hidden_dim': 1024,
        'num_beams': 4
    }
